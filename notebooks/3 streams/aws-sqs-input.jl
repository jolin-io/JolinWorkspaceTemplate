...
# ╔═╡ 761d03a2-79d9-4eb5-abaf-80369161bc2d
using PlutoUI, AWS, Dates, JolinPluto, Statistics

# ╔═╡ cba42527-c8fc-4cdb-9d3c-a3af80084054
md"""
# Ingest Stream

Adding random numbers onto SQS queue.
"""

# ╔═╡ b2637015-e139-4d66-b38e-490ec2355b2a
@output_below

# ╔═╡ 9e49ccb2-90f4-11ee-0628-4fb5688ead38
md"""
## Authorize AWS
"""

# ╔═╡ 32f1402b-88ec-45d8-afce-5e4e74321ad9
begin
...
# ╔═╡ 9ed8ac8d-a3c0-4218-b5ac-45105c0bf555
begin
	AWS.@service SQS
	queue_url = "https://sqs.eu-central-1.amazonaws.com/656386802830/ExampleQueue"
end

# ╔═╡ d4f85a37-76dd-4d4b-8181-d36741f17aee
md"""
## Generate Stream of Random Numbers
"""

# ╔═╡ 60e0137b-1a51-48d7-bb50-5f7c937c47fc
md"""
| Parameter | Choose | 
| ----------- | :--- |
| mean      | $(@bind mymean Select([-4, -1, 0, 1, 4, 20], default=0)) |
| standard deviation | $(@bind mystd Slider(1:1:10, default=1, show_value=true)) |
"""

# ╔═╡ d7ae922a-8205-4a44-85aa-cdf75f14722d
update = @repeat_at(ceil(Dates.now(), Dates.Millisecond(300))) do time
	randn() * mystd + mymean
end

# ╔═╡ 192e50bf-fc56-4879-9d96-f791c6163a79
SQS.send_message(string(update), queue_url)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "04d6dcc7a3d92eafd3b9b6d5b149ddb007defed4"
