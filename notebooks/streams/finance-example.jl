...
# ╔═╡ 1fd9f624-e857-4936-92d7-31a61ee4529c
md"""
# Memory tracking
"""

# ╔═╡ e528a12d-e8f8-4657-9b1c-9c5302bdb032
n_gc_live_bytes = 150

# ╔═╡ 44d27c89-60d5-4ecf-82d4-36f5d54756ea
list_gc_live_bytes = CircularBuffer{Float64}(n_gc_live_bytes)
...
md"""
We need a counter on the raw_price in order to do some initialization on the first time.
"""
...
# ╔═╡ ae0b8757-96d1-4387-851d-0c320b1201fe
md"""
everything else is reinitiated on reset
"""
...
# ╔═╡ c2967a75-6c0a-465e-9d22-2fcbbb94de43
typeof(NormalMeanPrecision(1.0, 1.0))
...
reset; counter_raw_price = Ref(0)

# ╔═╡ b130240a-2897-44f0-ae4f-4ac9bed340fc
begin
	raw_price
	if counter_raw_price[] < 1000
		counter_raw_price[] += 1
	end
	counter_raw_price[]
end

# ╔═╡ bf509b85-d75f-4365-b1c7-abd2d6b23290
if counter_raw_price[] == 1
	# (re)initialize x-priors the first time a new raw price arrives
	prior_x[] = NormalMeanPrecision(raw_price, mean(prior_x_τ[]))
end
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "b012aae649cbc4651ca2b093c6314f0b566c7b07"
...
git-tree-sha1 = "4f93e0dbdf4ac1a9f934c2d6e9f78d4736347599"
...
[[deps.JolinPluto]]
deps = ["AWS", "Base64", "Continuables", "Dates", "Git", "HTTP", "HypertextLiteral", "JSON3", "JWTs", "PlutoHooks"]
git-tree-sha1 = "dd57974f5a92bdf170074d26308103986c9f73c8"
