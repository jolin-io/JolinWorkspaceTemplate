...
using HTTP, JolinPluto, JSON3, Plots, Dates
...
begin
	...
	# 	push!(resetted)
	# end
	plot(buffer_raw_eventtimes, buffer_raw_prices, xrotation = 20, xlabel="time", ylabel="EURO")
end
...
git-tree-sha1 = "cd137e0c25d4b74123c86d0be11a9fb252b2beab"
