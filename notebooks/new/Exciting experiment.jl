...
begin
	...
	prior_x_τ = Ref(GammaShapeRate(1.0, 0.5)) # lower rate means higher variances
	prior_y_τ = Ref(GammaShapeRate(1.0, 2.0)) # higher rate means lower variances
...
@bind ci Slider(0.2:0.99:0.1, default=0.95, show_value=true)
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "d4855102d064c4d777b496b94ae927ab4645bd78"
