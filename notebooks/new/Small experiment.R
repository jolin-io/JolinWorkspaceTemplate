### A Pluto.jl notebook ###
# v0.19.42
# ╔═╡ ec86fe9a-8a06-11ef-068d-37d4e8d6f991
library(JuliaCall)
julia_setup(installJulia=TRUE)
# for deconstructions like `c(a, b) %<-% list(1, 2)`
library(zeallot)
...
# ╔═╡ ec86fdee-8a06-11ef-2084-619230ca2c3c
MD("# Welcome to R")

# ╔═╡ ec86fec8-8a06-11ef-3950-3d6239cfa290
...
manifest_format = "2.0"
project_hash = "106dbadedb7a18079120afff5515c5acb9d98c5e"
