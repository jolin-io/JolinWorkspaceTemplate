### A Pluto.jl notebook ###
# v0.19.4201
# ╔═╡ 2de4de92-8ba0-11ef-2ad0-4360b6494d8f
from juliacall import Main as jl
jl.seval("using Jolin")

# ╔═╡ 2de4de1a-8ba0-11ef-314a-f135470b85c7
jl.MD("""
# Welcome to Python
""")

# ╔═╡ 2de4dea6-8ba0-11ef-17b3-13638407440b
# create a mandelbrot plot
# 🠋🠋🠋

# ╔═╡ 4818182e-8ba0-11ef-1f5f-ed2ccf569f39
### Import necessary libraries ###
import numpy as np

# ╔═╡ 481818a6-8ba0-11ef-2e18-4beade672949
import matplotlib.pyplot as plt

# ╔═╡ 48181914-8ba0-11ef-06ed-df7d2ff0f821
...
# ╔═╡ 48181964-8ba0-11ef-26f6-73ebff0242bd
# Set up grid of points
x_min, x_max = -2.5, 1.5
y_min, y_max = -2, 2
resolution = 1000

# ╔═╡ 481819b4-8ba0-11ef-1167-5dc1631df2cc
x = np.linspace(x_min, x_max, resolution)
y = np.linspace(y_min, y_max, resolution)

# ╔═╡ 481819f0-8ba0-11ef-3c72-1d57bdfd917c
# Create meshgrid
X, Y = np.meshgrid(x, y)

# ╔═╡ 48181a86-8ba0-11ef-0667-ff8d76103f8a
# Generate Mandelbrot set
mandelbrot_set = np.zeros((resolution, resolution))

# ╔═╡ 48181ae0-8ba0-11ef-308d-a78fd51a531e
for i in range(resolution):
    for j in range(resolution):
        mandelbrot_set[i, j] = mandelbrot(complex(X[i, j], Y[i, j]), 100)

# ╔═╡ 48181b4e-8ba0-11ef-35b6-ef587d0621c2
# Initialize plot
fig, ax = plt.subplots(figsize=(10, 10))
# Plot Mandelbrot set
ax.set_xticks([])
ax.set_yticks([])
ax.imshow(mandelbrot_set.T, extent=(x_min, x_max, y_min, y_max), cmap='hot')
plt.title('Mandelbrot Set')

plt.gcf()

# ╔═╡ 48181bbc-8ba0-11ef-2062-3ff7b622ab44
# 🠉🠉🠉
# create a mandelbrot plot
