### A Pluto.jl notebook ###
# v0.19.42
# ╔═╡ f45b3856-855a-11ef-0045-1d5139e8e08d
# from juliacall import Main as jl
# jl.seval("using Jolin")

# ╔═╡ f97f51c8-855a-11ef-1e28-77f16b7c3911
jl.MD("""
### Importing Libraries
""")

# ╔═╡ f98c3532-855a-11ef-26ff-ada3026c4ec8
jl.MD("""
### Example Data
""")

# ╔═╡ f98c40e0-855a-11ef-1e86-792bde9cff60
# Generating random data
np.random.seed(42)
x = np.random.rand(100)
y = 2 * x + np.random.normal(0, 0.1, 100)

# ╔═╡ f98c411c-855a-11ef-2776-f3696ce89920
jl.MD("""
### Data Processing in Julia
""")

# ╔═╡ f98c459a-855a-11ef-3e1d-6d793a21bd76
# Sending data to Julia for processing
jl.assign("x_data", x)
jl.assign("y_data", y)

# ╔═╡ f98c45cc-855a-11ef-09d7-a71436546408
# Fitting a linear model in Julia using the Jolin package
jl.seval("""
using Jolin

# ╔═╡ f98c45fe-855a-11ef-1961-014cddad12a9
# Creating a linear regression model
model = lm(x -> x[1] * x_data + x[2], [0.0, 0.0])

# ╔═╡ f98c4626-855a-11ef-24e8-af8b7cb575e9
# Fitting the model
fit!(model, y_data)

# ╔═╡ f98c4658-855a-11ef-2fae-c9564dabce5b
# Getting the coefficients
coefficients = coef(model)
""")

# ╔═╡ f98c468a-855a-11ef-35af-5da6d644753b
# Retrieving the coefficients from Julia
coefficients = jl.rget("coefficients")
slope = coefficients[0]
intercept = coefficients[1]

# ╔═╡ f98c493c-855a-11ef-1b60-57423f86e155
f'Slope: {slope}, Intercept: {intercept}'

# ╔═╡ f98c496e-855a-11ef-39eb-2d0f032f8a6a
jl.MD("""
### Visualization
""")

# ╔═╡ f98c4df6-855a-11ef-2a59-8d58c0b0cd6e
import matplotlib.pyplot as plt

# ╔═╡ f98c4e3c-855a-11ef-3367-e1a16ce4b6b4
...
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_title('Linear Regression using Julia')
ax.legend()


plt.gcf()

# ╔═╡ f98c4068-855a-11ef-10c5-5f706dcb4e0e
# Let's create some example data in Python
import numpy as np

# ╔═╡ f98c3410-855a-11ef-3967-61c053bb3c72
from juliacall import Main as jl

# ╔═╡ f98b46b8-855a-11ef-10f3-cb93e1d480ae
from juliacall import Main as jl

# ╔═╡ f98c40ae-855a-11ef-0c91-0d0a99a1386c
# Let's create some example data in Python
import numpy as np
