### A Pluto.jl notebook ###
# v0.19.4201
# ╔═╡ 55f9a194-8b9e-11ef-0892-2dda520ca8c8
from juliacall import Main as jl
jl.seval("using Jolin")

# ╔═╡ 55f9a130-8b9e-11ef-34ff-db28a4962cfa
jl.MD("""
# Welcome to Python
""")

# ╔═╡ 55f9a1a8-8b9e-11ef-2930-4babdec0852f
# create a heatmap plot of the mandebrot set

# ╔═╡ dc2a80aa-8b9e-11ef-113e-c3ef34a26b27
### Import necessary libraries for creating a heatmap plot of the Mandelbrot Set ###

import numpy as np
import matplotlib.pyplot as plt
from matplotlib.colors import LinearSegmentedColormap

# ╔═╡ dc2b65ea-8b9e-11ef-329c-a7c8867bc22f
### Generate data for the Mandelbrot Set heatmap plot ###

# ╔═╡ dc2b664e-8b9e-11ef-0ca6-11bbdce96c76
# Define the size of the plot
width, height = 1000, 1000
x_min, x_max = -2.5, 1.5
y_min, y_max = -2, 2

# ╔═╡ dc2b6680-8b9e-11ef-21c7-39c3374048fd
# Generate complex grid points
x = np.linspace(x_min, x_max, width)
y = np.linspace(y_min, y_max, height)
X, Y = np.meshgrid(x, y)
Z = X + 1j*Y

# ╔═╡ dc2b66bc-8b9e-11ef-0798-ef1f9e70e1e3
# Initialize arrays for mandelbrot set
mandelbrot = np.zeros(Z.shape)

# Perform Mandelbrot set iterations
max_iter = 100
for i in range(max_iter):
    mandelbrot = mandelbrot**2 + Z
    diverged = np.abs(mandelbrot) > 2
    mandelbrot[diverged] = i

mandelbrot = mandelbrot / np.max(mandelbrot)

# ╔═╡ dc2b6c20-8b9e-11ef-2da9-d7e6b387e77e
### Create the heatmap plot of the Mandelbrot Set ###

# ╔═╡ dc2b6c52-8b9e-11ef-2c9c-39a54a661872
# Define a custom colormap for the Mandelbrot Set
colors = [(0, 0, 0), (1, 1, 1), (0.5, 0.5, 0.5)]
mandelbrot_cmap = LinearSegmentedColormap.from_list('mandelbrot', colors, N=max_iter)

# ╔═╡ dc2b6ca2-8b9e-11ef-069a-c77841c3b459
# Plot the Mandelbrot Set heatmap
fig, ax = plt.subplots(figsize=(10, 10))
heatmap = ax.imshow(mandelbrot, cmap=mandelbrot_cmap, extent=(x_min, x_max, y_min, y_max))
ax.set_title('Mandelbrot Set Heatmap')
ax.set_xlabel('Re(c)')
ax.set_ylabel('Im(c)')
cbar = plt.colorbar(heatmap)
cbar.set_label('Iterations to Divergence')
