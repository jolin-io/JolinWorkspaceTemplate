### A Pluto.jl notebook ###
# v0.19.42
# ╔═╡ 20237ad8-8a07-11ef-3bb5-8334b9a02ae1
from juliacall import Main as jl
jl.seval("using Jolin")

# ╔═╡ c76055b9-10db-43c2-8b9e-131d7dfafd85
jl.MD("""
# My Data App

key value data scientists: 
- notebook + automated devops

key value project manager: 
- super fast development cycle
""")

# ╔═╡ 20237a60-8a07-11ef-16c8-7bf010bbae6c
jl.MD("""
# Welcome to Python
""")

# ╔═╡ 01aa3d40-2bc5-46bf-afca-d2ba6db31c3b
jl.MD("""
# This is a reactive notebook

key needs:
- processing data
- creating individual "data apps" (websites, dashboards, services like pdf processing)

personas
- Data Scientist
- Projectleaders

companies (a lot of data)
- insurances
- financial surfaces - they need compliance things
- supermarkets
- ecommerces
...
# ╔═╡ 720df52c-6e5b-4c9c-b7ad-f073a54e0332
data_weather = download("internalwebsite.mycompany.com")

# ╔═╡ aca0113d-990b-4cc1-9d72-7e13cb092a4c
data = read_updates_from("asdhjklasd")

# ╔═╡ 33700ef5-665b-4dba-88f5-811bb43e9cd5
a, ui = jl.viewof("a", jl.Slider(range(50)))

# ╔═╡ f06b3e36-5c05-4d17-abba-835da8b7aa86
ui

# ╔═╡ b069ea27-b0c2-43f4-ac67-e05f45407df3
ui

# ╔═╡ d371d37e-7865-4b60-a303-9851835c0808
a

# ╔═╡ f7d71907-8d30-4e40-9428-0af669669020
n = 10*a

# ╔═╡ db7ba428-e38e-4940-837f-83af5cf3459a
output = jl.plot(jl.rand(n))

# ╔═╡ 46045c14-af55-427d-b2b7-94a8c9eb6591
output
