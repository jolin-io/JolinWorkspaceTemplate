...
# ╔═╡ 4a90f4dc-7e93-43ad-a1ab-a4e039b77c67
using JolinPluto, AWS, Base64

# ╔═╡ d8ceac5e-47fb-4797-a24e-e7fa359d0fef
md"""
# Input Stream
"""

# ╔═╡ c99e8cfa-3a19-423d-9853-79a2c7ba8cd4
@output_below

# ╔═╡ a386943a-9647-467e-8bf8-093fd1782ef0
begin
...
# ╔═╡ cd2d1d60-6e62-4dfe-8533-c1281de9ef5d
begin
	AWS.@service SQS
	queue_url = "https://sqs.eu-central-1.amazonaws.com/656386802830/ExampleQueue"
end

# ╔═╡ 406787e5-b43a-4b2f-96be-e62e8d7ff2cc
SQS.send_message("Works - yeah!", queue_url)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "2d79216ead83cf794c7834b0d00410897b2f7a6e"
...
git-tree-sha1 = "1b41a32089d9aee30f730791271011e0f684ea39"
