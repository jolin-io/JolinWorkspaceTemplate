...
# ╔═╡ 4e9b2d7e-ea54-11ed-321f-a988553aa626
using JolinPluto, AWS

# ╔═╡ 6f19a3a0-ea7c-41d6-8956-f673c18f73d7
@output_below

# ╔═╡ 247d9125-0035-4235-8d50-88b52c048aff
begin
...
# ╔═╡ fee0b04e-9074-4468-b800-e4a380e30ffe
begin
	AWS.@service SQS
	queue_url = "https://sqs.eu-central-1.amazonaws.com/656386802830/ExampleQueue"
end

# ╔═╡ 453f352f-e153-4a9c-ab33-408b2f3e26f4
...
# ╔═╡ 41d8fba9-7869-4d1f-b86d-96674402ffd6
message = @take_repeatedly! messages

# ╔═╡ dd3c29ae-95a4-4a02-b28b-a54413dc96ff
result = message["ReceiveMessageResult"]["Message"]["Body"]

# ╔═╡ 360b6d3f-dc6b-4b3d-8a08-1a45d8aa148d
begin
	result # explicit dependency so that this does not run if something failed
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "06a2360db2a42f5f58bbc16acb5cf176253c67f5"
...
git-tree-sha1 = "e8f61e4b1911f6c9aa37c60af64fb5c4949836a7"
